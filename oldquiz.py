...
def question2():
  ...
  if ans2 == "false" or  ans2 == "f":
    print("Correct")
    score += 1
    print("Score:",score)
    question3()

  elif ans2 == "true" or ans2 == "t":
...
def question3():
  ...
  if ans3 == "true" or ans3 == "t":
    print("Correct")
    score += 1
    print("Score:",score)
    question4()

  elif ans3 == "false"or ans3 == "f":
...
def question4():
  ...
  if ans4 == "false" or ans4 == "f":
    print("Correct")
    score += 1
    print("Score:",score)
    question5()

  elif ans4 == "true" or ans4 == "t":
...
def question5():
  ...
  if ans5 == "false" or ans5 == "f":
    print("Correct")
    score += 1
    final_score()
    
  elif ans5 == "true" or ans5 == "t":
